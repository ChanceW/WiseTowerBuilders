...
-- CreateIndex
CREATE UNIQUE INDEX "Study_studyGroupId_isCurrent_key" ON "Study"("studyGroupId", "isCurrent");
...
-- AddForeignKey
ALTER TABLE "Study" ADD CONSTRAINT "Study_studyGroupId_fkey" FOREIGN KEY ("studyGroupId") REFERENCES "StudyGroup"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
